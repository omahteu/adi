    ...
    if (valor.length >= 3) {
        ...
        if (resposta['erro']) {
            ...
            for (i = 0; i < resposta['dados'].length; i++) {
                htmlU += "<li class='list-group-item list-group-item-action' onclick='get_id_usuario(" + resposta['dados'][i].id + "," + JSON.stringify(resposta['dados'][i].nome_razao_social) + ")'>" + resposta['dados'][i].nome_razao_social + "</li>";
            }
        }
        htmlU += "</ul>";
